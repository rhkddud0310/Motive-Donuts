...
public class App_04 extends JFrame {
	...
	private JLabel getLblIPhone() {
		if (lblIPhone == null) {
			...
			lblIPhone.setIcon(new ImageIcon(App_04.class.getResource("/com/javalec/image/아이폰 테두리.png")));
	...
	private JLabel getLblScreen() {
		if (lblScreen == null) {
			...
			lblScreen.setIcon(new ImageIcon(App_04.class.getResource("/com/javalec/image/App04.png")));
	...
	private JLabel getLblClick() {
		if (lblClick == null) {
			...
			lblClick.setBounds(49, 114, 97, 21);
		}
		return lblClick;
	}
	// --- Function ---
	private void clickAction() {
		...
		App_05 app_05 = new App_05();
		app_05.setVisible(true);
	}
} // End
